//functional requirment instance generated from row 81
Instance: CHE.FXREQ.007.C
InstanceOf: SGRequirements
Usage: #definition
* title = "Provide decision support as appropriate for users "
* status = $pubStatus#active
* name = "Provide decision support as appropriate for users "
* publisher = "WHO"
* experimental = true
...
* extension[userstory].extension[capability].valueString = "Provide decision support as appropriate for users "
...
>Provide decision support as appropriate for users 
